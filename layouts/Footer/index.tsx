          ...
          >
            <div className="accordion-body">
              <ul className="list-group ">
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0 border-top-0">Home</li>
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0">Leilões</li>
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0">Venda seu Cavalo</li>
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0">Notícias</li>
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0 ">Sobre</li>
                <li className="list-group-item bg-transparent text-white border border-end-0 border-start-0 border-bottom-0">Contato</li>
              </ul>
            </div>
          </div>
        </div>
